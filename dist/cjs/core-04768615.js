...
const patchBrowser = () => {
    ...
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('core-04768615.js', document.baseURI).href));
...
const postUpdateComponent = (elm, hostRef, cmpMeta) => {
    ...
    // the deepest elements load first then bubbles up
    {
        ...
        if (hostRef.$flags$ & 512 /* needsRerender */) {
            nextTick(() => scheduleUpdate(elm, hostRef, cmpMeta));
        }
